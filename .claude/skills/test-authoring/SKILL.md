...
- Full-stack E2E: start only the repository-owned services required by the test and use project-scoped fixture cleanup.
...
- Prefer deterministic mock fixtures and project-scoped resets for integration environments.
