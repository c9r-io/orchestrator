...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::source::source_connection_catalog_get,
            commands::source::source_connection_list,
            commands::source::source_connection_get,
            commands::source::source_connection_connect,
            commands::source::source_connection_dedicated_preview,
            commands::source::source_connection_dedicated_approve,
            commands::source::source_connection_dedicated_get,
            commands::source::source_connection_dedicated_abandon,
            commands::source::source_connection_migrate_to_shared,
            commands::source::source_connection_dedicated_upgrade_preview,
            commands::source::source_connection_dedicated_upgrade_apply,
            commands::source::source_connection_dedicated_delete,
            commands::source::source_connection_intent_get,
            commands::source::source_connection_cancel,
            commands::source::source_connection_reauthorize,
            commands::source::source_connection_disconnect,
            commands::source::source_connection_transfer,
            commands::source::open_source_connection_oauth,
            commands::source::start_source_connection_watch,
            commands::source::stop_source_connection_watch,
