...
pub struct StepExecutionAccumulator {
    ...
    pub phase_artifacts: Vec<agent_orchestrator::collab::Artifact>,
...
impl StepExecutionAccumulator {
    ...
    pub fn to_prehook_context(
        ...
        StepPrehookContext {
            ...
            self_referential_safe: agent_orchestrator::ticket::is_self_referential_safe(
    ...
    pub fn apply_run_diagnostics(&mut self, result: &agent_orchestrator::dto::RunResult) {
