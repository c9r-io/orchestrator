...
pub use orchestrator_client::config::{
    ClusterRef, ContextRef, ControlPlaneConfig, NamedCluster, NamedContext, NamedUser, UserRef,
};
...
pub(crate) fn required_role_for_rpc(rpc: &str) -> Role {
    match rpc {
        ...
        | "SourceAutomationReplay" | "SourceAutomationIgnore"
