...
Workflow configuration is detailed in [Chapter 03](workflow-configuration.md).
...
- [03 - Workflow Configuration](workflow-configuration.md) — step definitions, scopes, loops
- [04 - CEL Prehooks](cel-prehooks.md) — dynamic step gating
