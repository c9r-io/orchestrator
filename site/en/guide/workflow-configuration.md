...
Rules are evaluated in order; the first match wins. See [Chapter 04](cel-prehooks.md) for finalize-context variables.
...
- [04 - CEL Prehooks](cel-prehooks.md) — dynamic step gating and all available variables
- [05 - Advanced Features](advanced-features.md) — CRDs, stores, task spawning
