          ...
          '/en/showcases/': [
            {
              ...
              items: [
                ...
                { text: 'Secret Rotation', link: '/en/showcases/secret-rotation-workflow' },
                { text: 'Skill Setup', link: '/en/showcases/skill-setup-execution' },
          ...
          '/zh/showcases/': [
            {
              ...
              items: [
                ...
                { text: '密钥轮替', link: '/zh/showcases/secret-rotation-workflow' },
                { text: 'Skill 初始化', link: '/zh/showcases/skill-setup-execution' },
              ],
            },
          ],
        },
