...
#[cfg(target_os = "linux")]
use crate::sandbox_network::{validate_network_allowlist, NetworkAllowlistEntry};
...
impl SandboxBackendError {
    fn unsupported_network_allowlist(
...
fn select_sandbox_backend(execution_profile: &ResolvedExecutionProfile) -> SandboxBackend {
...
fn detect_linux_sandbox_support(
    execution_profile: &ResolvedExecutionProfile,
) -> LinuxSandboxSupport {
    #[cfg(target_os = "linux")]
    {
