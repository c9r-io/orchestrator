...
"$BINARY" apply -f fixtures/manifests/bundles/pause-resume-workflow.yaml 2>/dev/null || { qa_error "Failed to apply config manifest"; exit 2; }
qa_resolve_project "qa-pause-resume"
qa_prepare_project "qa_sleep"
