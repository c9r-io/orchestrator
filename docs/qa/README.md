...
| orchestrator | `docs/qa/orchestrator/59-dynamic-dag-mainline-execution.md` | 4 | FR-004: explicit `dynamic_dag` mode, CEL trigger validation, graph materialization, graph-aware trace |
