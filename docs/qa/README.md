...
| orchestrator | `docs/qa/orchestrator/176-agent-driver-execution-migration.md` | 5 | FR-126 exact typed-driver inventory, command-only promotion, shell semantic preservation, global executor retirement, and repository closure |
...
| FR-126 | DD-138 / QA-176 | Yes | Promoted/explicit shell parity | `test-agent-driver-execution-migration.sh` | No | No |
