...
| orchestrator | `docs/qa/orchestrator/163-dedicated-slack-app-auto-provisioning.md` | 5 | FR-115 fixed-manifest private App creation, local Configuration Token custody, receipt-gated import, cross-App isolation, recovery, reviewed upgrade/delete, mode migration, UI, and live certification |
