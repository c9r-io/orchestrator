...
| 5 | SecretStore values redacted in task logs | PASS | 2026-03-31 | Claude | 5 sub-tests passed: `collect_sensitive_values_from_secret_store`, `collect_sensitive_values_skips_env_stores`, `test_collect_all_sensitive_store_values` (2 tests) |
