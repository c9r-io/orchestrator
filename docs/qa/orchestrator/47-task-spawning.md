...
| 5 | Spawn with custom workflow override | ✅ | 2026-03-31 | claude | Unit test: spawn_task_runner_returns_early_for_duplicate_task PASS. Code review: action.workflow optional override confirmed in spawn.rs lines 32-35, 101-106 |
