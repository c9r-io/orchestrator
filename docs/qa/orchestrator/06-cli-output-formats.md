...
- Recreate the isolated project scaffold: `orchestrator project reset "${QA_PROJECT}" --force 2>/dev/null || true && rm -rf "workspace/${QA_PROJECT}" && orchestrator apply --project "${QA_PROJECT}" --force`
