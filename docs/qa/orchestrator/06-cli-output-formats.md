...
- Recreate the isolated project scaffold: `orchestrator qa project reset "${QA_PROJECT}" --keep-config --force 2>/dev/null || true && rm -rf "workspace/${QA_PROJECT}" && orchestrator qa project create "${QA_PROJECT}" --force`
