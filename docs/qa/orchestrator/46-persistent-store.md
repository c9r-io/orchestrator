...
1. **Code review** — verify project-scoped isolation in store table:
   ```bash
   rg -n "project_id.*PRIMARY KEY|store_name.*project_id" core/src/service/store.rs
   ```
...
|---|----------|--------|-----------|--------|-------|
| 1 | Store Put / Get / Delete / List | PASS | 2026-03-15 | claude | CRUD round-trip unit test |
| 2 | WorkflowStore CRD with Schema Validation | PASS | 2026-03-15 | claude | Retention + config serde |
| 3 | StoreBackendProvider CRD and Command Adapter | PASS | 2026-03-15 | claude | Config serde + CRD projection |
| 4 | Store List / Output Formats / Project Isolation | PASS | 2026-03-15 | claude | Project-scoped PK + output formats |
| 5 | Builtin CRD Count and Describe Validation | PASS | 2026-03-15 | claude | 11 builtin CRDs verified |
