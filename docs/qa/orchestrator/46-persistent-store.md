...
|---|----------|--------|-----------|--------|-------|
| 1 | Store Put / Get / Delete / List | PASS | 2026-03-21 | claude | CRUD round-trip unit test |
| 2 | WorkflowStore CRD with Schema Validation | PASS | 2026-03-21 | claude | Retention + config serde |
| 3 | StoreBackendProvider CRD and Command Adapter | PASS | 2026-03-21 | claude | Config serde + CRD projection |
| 4 | Store List / Output Formats / Project Isolation | PASS | 2026-03-21 | claude | Project-scoped PK + output formats pass; S4 Step 1 file path corrected |
| 5 | Builtin CRD Count and Describe Validation | PASS | 2026-03-21 | claude | 11 builtin CRDs verified |
