...
|---|----------|--------|-----------|--------|-------|
| 1 | Backfill Infers Step Scope From Item Binding | ✅ | 2026-03-28 | Claude | `m0002_backfills_event_step_scope_from_task_item_id` passes |
| 2 | Backfill Is Idempotent | ✅ | 2026-03-28 | Claude | `backfill_is_noop_and_returns_zero_stats` passes |
...
| 4 | Verbose Trace Explains Legacy Scope | ✅ | 2026-03-28 | Claude | Code review: trace.rs → "unspecified", watch.rs → "~"; test `render_watch_frame_shows_unspecified_scope_marker_for_missing_scope_event` passes |
