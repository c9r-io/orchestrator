...
See [Hello World Customization Guide](hello-world.md#replace-with-a-real-agent). With a real agent, the fr_triage step will actually read the FR document and produce a triage report.

## Further Reading

- [Scheduled Scan Template](scheduled-scan.md) — Cron Trigger example
- [Secret Rotation Workflow](secret-rotation-workflow.md) — Webhook Trigger example
