...
- [Plan & Execute Template](plan-execute.md) — multi-step workflow for use with `--step` partial execution
- [Hello World Template](hello-world.md) — minimal runnable workflow
- [CLI Reference](../guide/07-cli-reference.md) — full `run` command parameter reference
- [Workflow Configuration](../guide/03-workflow-configuration.md) — step definitions, scope, loop policy details
