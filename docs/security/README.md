...
13. Before enabling FR-115 dedicated provisioning, repeat the managed Slack suite with `docs/qa/orchestrator/163-dedicated-slack-app-auto-provisioning.md`, including Configuration Token retention scans, cross-App signature/receipt canaries, orphan Attention recovery, and the controlled dedicated sandbox addendum.
