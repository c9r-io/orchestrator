...
- Integrated UI: 61 Vitest tests, 15 Playwright tests, source-wide frontend coverage reporting, production build, accessibility checks, and real Tauri handler to gRPC flow.
