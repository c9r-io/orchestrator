...
Before this change, [`docs/workflow/self-evolution.yaml`](../../workflow/self-evolution.yaml) captured:
...
[`crates/orchestrator-config/src/config/step.rs`](../../../crates/orchestrator-config/src/config/step.rs) now defines:
...
[`crates/orchestrator-scheduler/src/scheduler/item_executor/accumulator.rs`](../../../crates/orchestrator-scheduler/src/scheduler/item_executor/accumulator.rs) now:
...
[`core/src/json_extract.rs`](../../../core/src/json_extract.rs) now owns `extract_stream_json_result()`, and [`crates/orchestrator-scheduler/src/scheduler/item_generate.rs`](../../../crates/orchestrator-scheduler/src/scheduler/item_generate.rs) reuses the same helper.
...
[`docs/workflow/self-evolution.yaml`](../../workflow/self-evolution.yaml) now captures:
