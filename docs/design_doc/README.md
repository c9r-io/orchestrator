...
| orchestrator | `docs/design_doc/orchestrator/136-coordination-strangler-completion.md` | `docs/qa/orchestrator/174-coordination-strangler-completion.md` | Exact production workflow inventory, seven typed-tool migrations, explicit session/tool boundaries, monotonic legacy ratchet, retirement criteria, and isolated two-cycle parity |
| orchestrator | `docs/design_doc/orchestrator/137-legacy-coordination-decommission.md` | `docs/qa/orchestrator/175-legacy-coordination-decommission.md` | Capture/JSONPath production removal, narrow residual state, exact generic-variable and command-only Agent blockers, post-retirement tool regression, and monotonic retirement evidence |
