...
| orchestrator | `docs/design_doc/orchestrator/21-sandbox-resource-network-enforcement.md` | `docs/qa/orchestrator/56-sandbox-resource-network-enforcement.md` | FR-001 closure: Unix resource limits, structured sandbox resource/network events, unsupported allowlist gating |
