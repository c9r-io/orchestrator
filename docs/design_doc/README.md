...
| orchestrator | `docs/design_doc/orchestrator/142-core-boundary-freeze.md` | `docs/qa/orchestrator/180-core-boundary-freeze.md` | Core public surface and per-file `rusqlite` inventory frozen by exact equality, plus the reviewed migration schema baseline with idempotency and resume at all 74 interruption points |
