...
| orchestrator | `docs/design_doc/orchestrator/30-async-lock-model-alignment.md` | `docs/qa/orchestrator/69-async-lock-model-alignment.md` | FR-016 closure: config snapshots via `ArcSwap`, async telemetry locks, and documented synchronous exceptions |
