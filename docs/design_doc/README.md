...
| orchestrator | `docs/design_doc/orchestrator/130-coordination-collapse-mcp-tools.md` | `docs/qa/orchestrator/168-coordination-collapse-mcp-tools.md` | Authenticated per-run daemon tool host, transport-only stdio shim, five real coordination tools, complete events, parity pilot, and measured residual channels |
