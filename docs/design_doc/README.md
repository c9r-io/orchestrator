...
| orchestrator | `docs/design_doc/orchestrator/128-non-code-workspace-and-global-file-sharing.md` | `docs/qa/orchestrator/165-non-code-workspace-and-global-file-sharing.md` | Task workspaces, implicit process items, operator-owned file-sharing ceiling, isolated HOME, global Skills, Console semantics, and Slack pilot |
