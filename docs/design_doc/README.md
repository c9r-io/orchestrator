...
| orchestrator | `docs/design_doc/orchestrator/126-dedicated-slack-app-auto-provisioning.md` | `docs/qa/orchestrator/163-dedicated-slack-app-auto-provisioning.md` | FR-115 per-workspace private Slack App provisioning, local token custody, exact-App OAuth/events, reviewed manifest lifecycle/delete, bidirectional mode migration, and recovery Attention |
