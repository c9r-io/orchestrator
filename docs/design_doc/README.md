...
| orchestrator | `docs/design_doc/orchestrator/29-clone-reduction-and-shared-ownership.md` | `docs/qa/orchestrator/67-clone-reduction-and-shared-ownership.md` | FR-015 first batch: shallow-shared runtime context fields, owned daemon summary mapping, and clone hotspot governance |
