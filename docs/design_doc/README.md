...
| self-bootstrap | `docs/design_doc/self-bootstrap/03-self-restart-capability.md` | `docs/qa/self-bootstrap/07-self-restart-process-continuity.md` | Self-restart: rebuild binary, exit 75, wrapper relaunch, restart_pending resumption |
