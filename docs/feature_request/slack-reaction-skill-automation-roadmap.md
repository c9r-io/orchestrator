...
- Hosted multi-tenant Slack connection management；这是不重开本路线图的 post-release follow-up：已闭环的共享官方 App OAuth 与统一连接/Gateway 基础见 [Design 125](../design_doc/orchestrator/125-managed-slack-connection-shared-oauth.md)，每 workspace 独立 App 自动 provisioning 见 [FR-115](FR-115-dedicated-slack-app-auto-provisioning.md)。
