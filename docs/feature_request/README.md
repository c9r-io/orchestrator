...
| FR-130 | Core Crate 拆分 Phase 3 — persistence 提取 | P1 | In Progress（需求 1、3、Phase A 与 Phase C 已闭环；Phase B 进行中，6 / 18 文件） |
