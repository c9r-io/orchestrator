...
| FR-130 | Core Crate 拆分 Phase 3 — persistence 提取 | P1 | In Progress（需求 1、3 与需求 2 的 Phase A 已闭环；Phase B/C 未完成） |
