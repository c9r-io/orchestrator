...
| FR-101 | 统一控制面 Action Audit Envelope | P0 | Proposed |
...
- FR-095 至 FR-100 已闭环为基础 DD/QA 产物；2026-07-14 实现审计识别出的跨切片缺口由 FR-101 至 FR-104 承载，整体状态与依赖顺序见 `docs/feature_request/agent-process-console-roadmap.md`
