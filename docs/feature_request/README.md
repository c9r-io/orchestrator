...
- FR-126 已闭环删除；其设计与验证信息现由 `docs/design_doc/orchestrator/138-agent-driver-execution-migration.md` 与 `docs/qa/orchestrator/176-agent-driver-execution-migration.md` 承载（20 个生产 Agent 全部 typed driver 化、command-only 确定性提升、全局 runner selector 退役、shell 语义与共享安全 spawn 保留）
