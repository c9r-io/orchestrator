...
- FR-126 已经第三轮严格审计补证后重新闭环删除；EN/ZH 用户指南、架构、authoring skill 与 DD-101/DD-127 已对齐 typed driver 现状，production admission/runtime compatibility 分层成为机器可读 fixture，确定性 guide semantics negative gate 已接入 `qa-doc-lint` 和默认 release closure。设计与验证证据由 `docs/design_doc/orchestrator/138-agent-driver-execution-migration.md`、`docs/design_doc/orchestrator/guide-alignment.md`、`docs/qa/orchestrator/176-agent-driver-execution-migration.md` 与 `docs/qa/orchestrator/guide-alignment.md` 承载。
