...
13. For FR-114 Sources → Connections and managed OAuth, run `05-responsive-layout.md`, `06-navigation-ia.md`, `07-accessibility.md`, `08-forms-validation.md`, and `10-dialogs-notifications.md` with `docs/qa/orchestrator/162-managed-slack-connection-shared-oauth.md` Scenario 4.
14. For FR-115 Dedicated Slack App provisioning and lifecycle, repeat the Sources → Connections suite with `docs/qa/orchestrator/163-dedicated-slack-app-auto-provisioning.md` Scenarios 1, 3, 4, and 5; include password clearing, semantic permission diff, reviewed creation/upgrade/migration/delete, recovery Attention, safe reload state, accessibility, and narrow layout.
