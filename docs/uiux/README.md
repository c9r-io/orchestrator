...
14. For FR-115 Dedicated Slack App provisioning, repeat the Sources → Connections suite with `docs/qa/orchestrator/163-dedicated-slack-app-auto-provisioning.md` Scenarios 1, 3, and 5; include password clearing, semantic permission diff, reviewed creation, recovery Attention, and safe reload state.
